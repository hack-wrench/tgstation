...
/mob/living/carbon/human/proc/viewed_by_human(mob/living/carbon/human/viewer)
	for(var/obj/item/equipment in list(head, wear_mask, glasses, ears, wear_neck, wear_suit, w_uniform, back, gloves, belt, wear_id, shoes))
		if(istype(equipment))
			SEND_SIGNAL(equipment, COMSIG_HUMAN_VIEW_EQUIPMENT, viewer)
